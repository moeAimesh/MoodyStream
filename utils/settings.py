...
TALKING_THRESHOLD_DEFAULT = 0.02  # fallback mouth-open variance threshold for talking detection
TALKING_THRESHOLD_MAX = 0.15  # clamp to avoid extreme values
TALKING_WINDOW = 10  # frames for talking variance window
TALKING_MIN_SAMPLES = 30  # minimum samples required during talking calibration
